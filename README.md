...
If you would like see how the current tests work, install jest using the command npm i jest. After jest is installed, type `npm test` in the command line. After running the `npm test` command, you should see passing tests in the command line as shown below.
